...
public class EditEventActivity extends AppCompatActivity {
    ...
    private void populateFields(DocumentSnapshot documentSnapshot) {
        ...
        etEditEventDescription.setText(event.getDescription());

        if (event.getEventDateTime() != null) {
            selectedDateMillis = event.getEventDateTime().toDate().getTime();
        } else {
    ...
    private void updateEventInFirestore() {
        ...
        updates.put("eventDateTime", new com.google.firebase.Timestamp(new java.util.Date(selectedDateMillis)));
